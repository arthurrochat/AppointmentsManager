...
public class Servidor implements Container {
	...
	public void handle(Request request, Response response) {
		try {
			...
			else if(path.startsWith("/Agendar")/* && "POST".equals(method)*/) {
				System.out.println("REQUISIÇÃO DE AGENDAMENTO");
				this.enviaResposta(Status.CREATED, response, UsuarioService.agendar(request));
			}
			else {
